...
/*
  Bitbang WS2812 write - T. B�scke May 26th, 2013
  ...
  * To send a zero the dataline is pulled low after 0.375�s (6+1 cycles).
  * To send a one the dataline is pulled low after 0.625�s (10+1 cycles).
...
// WS2812 Support - T. B�scke May 26th, 2013
